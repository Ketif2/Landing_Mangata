...
const Analytics = () => {
  return (
    <div tabIndex="0" id="Analytics" className="w-full bg-white py-8">
      <div tabIndex="0" className="max-w-[1240px] max-auto grid md:grid-cols-2">
        ...
        <div tabIndex="0" className="flex flex-col justify-center">
          <h1 tabIndex="0" className="text-[#3C0E1E] font-bold text-center text-3xl mb-6">
            NOSOTROS
          </h1>
          <div tabIndex="0" className="grid grid-cols-2 gap-6 px-2">
            <div tabIndex="0" className="pr-2">
              <h3 tabIndex="0" className="md:text-4xl sm:text-3xl text-2xl font-semibold py-4 ml-2 text-[#66293E]">
                ¿Quienes somos
              </h3>
              <p tabIndex="0" className="text-black">
            ...
            <div tabIndex="0" className="pl-1 pt-20">
              <h3 tabIndex="0" className="md:text-4xl sm:text-3xl text-2xl font-semibold py-4 text-[#66293E]">
                ¿Qué vendemos?
              </h3>
              <p tabIndex="0" className="text-black">
